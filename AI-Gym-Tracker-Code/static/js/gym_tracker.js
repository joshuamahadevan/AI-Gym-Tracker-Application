...
function resetTimer() {
  // Stop the timer and reset the seconds counter
  stopTimer();
  seconds = 0;
  displayTime();
}
...
function displayTime() {
  ...
  // Display the time in the timerElement
